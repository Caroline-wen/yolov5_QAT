...
def create_coco_train_dataloader(cocodir, batch_size=10):
    ...
    loader = create_dataloader(
        ...
        augment=True, hyp=hyp, rect=True, cache=False, stride=32, pad=0, image_weights=False)[0]
    return loader
 
 
def create_coco_val_dataloader(cocodir, batch_size=10):
    loader = create_dataloader(
...
def run_test(weight, device, cocodir, confidence, nmsthres):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--weight', type=str, default='yolov5s.pt', help='initial weight patsh')
    ...
    parser.add_argument("--qat", type=str, default=None, help="file")
    ...
    if args.export:
        ...
        run_test(args.weight, args.device, args.cocodir, args.confidence, args.nmsthres)
